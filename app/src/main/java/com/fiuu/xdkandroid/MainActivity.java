...
public class MainActivity extends AppCompatActivity {
    ...
    private void restartmolpay() {
        ...
        paymentDetails.put(MOLPayActivity.mp_bin_lock_err_msg, "Only Maybank card allowed");
...
//        paymentDetails.put(MOLPayActivity.mp_sandbox_mode, false); // Optional :  true = Test Environment & false = production (required Google Pay production access approval)(by default false)
